...
for expected in ('<Version>1.1.2</Version>', '<AssemblyVersion>1.1.2.0</AssemblyVersion>', '<FileVersion>1.1.2.0</FileVersion>', '<InformationalVersion>1.1.2</InformationalVersion>'):
