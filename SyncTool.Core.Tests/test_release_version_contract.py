...
for expected in ('<Version>1.1.3</Version>', '<AssemblyVersion>1.1.3.0</AssemblyVersion>', '<FileVersion>1.1.3.0</FileVersion>', '<InformationalVersion>1.1.3</InformationalVersion>'):
